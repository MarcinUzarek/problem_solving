...
// It looks like a chessboard, and every morning and evening you have to solve a new movement puzzle in order
// to cross the floor. That would be fine if you got to be the rook or the queen, but instead,
// you have to be the knight. Worse, if you take too much time solving the puzzle,
...
//        which is where you need to land to solve the puzzle.
//        The function should return an integer representing the smallest number of moves it will take for
//        you to travel from the source square to the destination square using a chess knight's moves
