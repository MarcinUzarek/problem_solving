...
class TheMillionthFibonacciTest {
    ...
    void should_return_correct_values_for_negative_entry() {
        assertThat(fib(BigInteger.valueOf(-1)), is(BigInteger.ONE));
        assertThat(fib(BigInteger.valueOf(-2)), is(BigInteger.valueOf(-1)));
        assertThat(fib(BigInteger.valueOf(-5)), is(BigInteger.valueOf(5)));
        assertThat(fib(BigInteger.valueOf(-6)), is(BigInteger.valueOf(-8)));
    }
    ...
    void should_work_for_large_positive_and_negative_numbers() {
        assertThat(fib(BigInteger.valueOf(2450)),
                is(new BigInteger("467986807230617714910953076537244448683512677900339401451602" +
        ...
        assertThat(fib(BigInteger.valueOf(-3200)),
                is(new BigInteger("-257610640709596932555361784958469927112418428321666809527044" +
    ...
    void should_return_0_for_given_0() {
        assertThat(fib(BigInteger.valueOf(0)), is(BigInteger.ZERO));
    }

    @Test
    void should_return_correct_values_for_positive_entry() {
        assertThat(fib(BigInteger.valueOf(4)), is(BigInteger.valueOf(3)));
        assertThat(fib(BigInteger.valueOf(9)), is(BigInteger.valueOf(34)));
    }
